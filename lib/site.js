...
async function buildHtml(content, options = {}) {
  ...
  const replacements = {
    ...
    '__HERO_URGENCY__': content.hero.urgency || '',
    '__HERO_CTA_BUTTON__': content.hero.cta_button || '',
    '__HERO_SOCIAL_PROOF__': content.hero.social_proof || '',
    '__HERO_TRUST__': content.hero.trust || '',
    ...
    '__SHEET_WEBHOOK_URL__': (content.integrations && content.integrations.sheet_webhook_url) || '',
