...
def build_html(content: dict) -> str:
    ...
    replacements = {
        ...
        "__HERO_URGENCY__": content["hero"].get("urgency", ""),
        "__HERO_CTA_BUTTON__": content["hero"].get("cta_button", ""),
        "__HERO_SOCIAL_PROOF__": content["hero"].get("social_proof", ""),
        "__HERO_TRUST__": content["hero"].get("trust", ""),
